...
stroke = st.number_input('Masukan akselarasi', step=0, max_value=100, min_value=1) = st.number_input('Masukan rasio goresan', step=0, max_value=100, min_value=1) = st.number_input('Masukan rasio goresan', step=0, max_value=100, min_value=1)
...
peakrpm = st.number_input('Masukan peakrpm', step=0, max_value=100, min_value=1)
